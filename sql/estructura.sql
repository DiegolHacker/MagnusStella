...
CREATE TABLE `cliente` (
  `idCliente` varchar(45) COLLATE utf8mb3_spanish_ci NOT NULL,
...
CREATE TABLE `venta` (
  ...
  `Fk_Venta_Cliente` varchar(45) COLLATE utf8mb3_spanish_ci NOT NULL,
  `Fk_Venta_Producto` varchar(25) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `Fecha` datetime NOT NULL,
  `SalesOrderNum` varchar(150) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`idVenta`),
...
-- Dump completed on 2024-05-02 19:23:28
