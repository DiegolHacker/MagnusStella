...
exports.post_ModifyProduct = (request,response,next) =>{
    ...
    ModifyProduct.ModificarProducto(MP.idProducto,MP.Columna,MP.NuevoValor).then(()=>{
        return response
        .status(200)
...
exports.post_NewProduct = (request, response, next) =>{
    ...
    const {idProducto,marcaProducto,Nombre,Image,Descripcion,categoria} = data;
    const NEWproduct = new ZecoreProductHelper(idProducto,marcaProducto,Nombre,Image,Descripcion,categoria);
